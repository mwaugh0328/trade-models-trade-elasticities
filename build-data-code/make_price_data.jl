...
input_isic = readdlm("./build-data-code/feenstra-trade-data/isic_3digit_manuf.txt")

drop_30 = DataFrame(CSV.File("./build-data-code/drop_30.csv"))
...
gross_output_file = "./build-data-code/UNIDO-data/UNIDO-grossoutput-data-2011.csv"
...
# grab the gross output data
gross_output_file = "./build-data-code/UNIDO-data/UNIDO-grossoutput-data-2004.csv"
